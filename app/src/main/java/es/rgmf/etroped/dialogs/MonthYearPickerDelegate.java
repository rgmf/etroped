...
public class MonthYearPickerDelegate {
    ...
    public MonthYearPickerDelegate(View parent) {
        ...
        // month
        mMonthSpinner = (NumberPicker) parent.findViewById(R.id.np_month);
        ...
        // year
        mYearSpinner = (NumberPicker) parent.findViewById(R.id.np_year);
